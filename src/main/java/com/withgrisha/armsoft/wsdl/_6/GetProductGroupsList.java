 ...
 *         &lt;element name="SortAsTree" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetProductGroupsList")
public class GetProductGroupsList {

    protected String sessionId;
    protected Integer seqNumber;
    @XmlElementRef(name = "ParentGroup", namespace = "http://www.armsoft.am/Accountant/6.0", type = JAXBElement.class)
    protected JAXBElement<String> parentGroup;
    @XmlElement(name = "SortAsTree")
    protected Boolean sortAsTree;
    ...
    public void setParentGroup(JAXBElement<String> value) {
        this.parentGroup = ((JAXBElement<String> ) value);
    }

    /**
     * Gets the value of the sortAsTree property.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
     *     
     */
    public Boolean isSortAsTree() {
        return sortAsTree;
    }

    /**
     * Sets the value of the sortAsTree property.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *     
     */
    public void setSortAsTree(Boolean value) {
        this.sortAsTree = value;
    }
