...
public class StartSession {
    ...
    @XmlElementRef(name = "UserName", namespace = "http://www.armsoft.am/Accountant/6.0", type = JAXBElement.class)
    protected JAXBElement<String> userName;
    @XmlElementRef(name = "Password", namespace = "http://www.armsoft.am/Accountant/6.0", type = JAXBElement.class)
    protected JAXBElement<String> password;
    @XmlElementRef(name = "DBName", namespace = "http://www.armsoft.am/Accountant/6.0", type = JAXBElement.class)
    protected JAXBElement<String> dbName;
    @XmlElementRef(name = "CultureName", namespace = "http://www.armsoft.am/Accountant/6.0", type = JAXBElement.class)
    ...
    public void setDBName(JAXBElement<String> value) {
        this.dbName = ((JAXBElement<String> ) value);
    }
